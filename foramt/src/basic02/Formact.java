	 ...
	 public static void main(String[] args) {
			...
			// 월: %tB, %tm  
			 ...
			 Calendar c = Calendar.getInstance();  
		      ...
		      System.out.format("%tp %tI:%tM %n", c, c, c);  // -->오전 11:03  / (현재시간)
		      System.out.format("%tD%n%n", c);    // -->  07/09/21  / (현재 월,일,연도)
			 ...
			 long n = 123456;
		      ...
		      System.out.format("%.3f%n", pi);     // -->  3.142       / .3 은 소수점자리이하 3개를 의미 
		      System.out.format("%10.3f%n", pi);   // -->       3.142  / 앞 공백5개, 뒤에 . 포인트 포함 5개까지 총10자리
